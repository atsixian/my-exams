...
const Safety = (
  <Card hoverable title="Is it safe?">
    This tool does not store your credentials. It transmits your credentials in a
...
const SixianGithub = <FollowButton user="deerhound579" name="Sixian" />;
const JiahaoGithub = <FollowButton user="jhcccc" name="Jiahao" />;
